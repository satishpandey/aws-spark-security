...
/**
 * Sample program showing AWS credentials configuration to fetch data from S3
 * bucket.
 * 
 * @author Satish Pandey
 *
 */
public class S3WordCountNormalCredentials {

	private final static Logger logger = LogManager.getLogger(S3WordCountNormalCredentials.class);
	private final static String APPLICATION_NAME = logger.getName();

	/*
	 * To run this application you have to provide S3 input file and output file
	 * as arguments. Example command: spark-submit --class
	 * com.spark.summit.samples.s3.S3WordCountNormalCredentials
	 * spark-summit-samples-0.0.1-SNAPSHOT.jar
	 * s3a://spark.data.com/shakespeare-1-100.txt s3a://spark.data.com/output
	 */
